...
import { ListDemandeService } from 'components/demandeService/ListDemandeService';
import agent from 'agent';

describe('ListDemandeService is rendering', () => {
    let component;
    let data = {
        0: {
...
describe('ListReferent behaves', () => {
    let component;
    let data = {
    { id, date, frequence, assumeFrais, motifs, transport, parent, secondParent, enfants, dispoFirstParent, dispoSecondParent}
        0: {
            Id: "1",
            Date: "referent@test.com",
            Fax: "123456789",
            Firstname: "Referent",
            Id: 1,
            Lastname: "Test",
