...
export default (state = defaultState, action) => {
  switch (action.type) {
    ...
    case UPDATE_ORGANISME_REFERENT:
      return {
        ...state,
        redirectTo: action.error ? null : '/organismereferent/' + action.payload.Email
      }
    ...
    case UPDATE_POINT_SERVICE:
      return {
        ...state,
        redirectTo: action.error ? null : '/pointservice/' + action.payload.Email
      }
    ...
    return {
      ...state,
      redirectTo: action.error ? null: '/demandeService/' + action.payload.Id
    }
