      ...
      <div className="profile-page">
        <div className="container page">
          ...
          <h1 className="text-xs-center">
            <FormattedMessage id="profile.title" defaultMessage="Mon Profil" />
          </h1>
          <hr />
          <hr />
          <br />
          <div className="container">
            <div className="row">
              <div className="text-xs-left">
                ...
                <h5 class="bold">
                  <FormattedMessage id="profile.role" defaultMessage="Titre:" />
                  <a href=""> {role} </a>
                  <br />
                  <FormattedMessage
                    id="profile.email"
...
Profile.propTypes = { intl: intlShape.isRequired };
