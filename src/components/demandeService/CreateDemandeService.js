            ...
            <div class="col-md-8 form-group">
                <div className="row">
                    <div class="col-md-6 form-group">
                        ...
                        {(values.serviceType.value === "1" || values.serviceType.value === "2") &&
                            <div className="row">
                                <div class="col-md-12 form-group">
                                    <h3 >Type: </h3>
                                    <Select
                                        value={values.values.state.firstParentTypeOption}
                                        onChange={values.values.handleChangeFirstParentType.bind(values.values)}
                                        isMulti={false}
                                        isSearchable={true}
                        ...
                        <fieldset>
                            <fieldset className="form-group">
                                <Select
                                    ...
                                    onChange={values.values.handleChangeAddressSelected.bind(values.values)} />
                            </fieldset>
                        </fieldset>
                        <fieldset>
                            <fieldset className="form-group">
                                <input
                                    ...
                                    onChange={values.values.handleChangeNoCiviqueFirstParent.bind(values.values)} />
                            </fieldset>
                        </fieldset>
                        <fieldset>
                            <fieldset className="form-group">
                                <input
                                    ...
                                    onChange={values.values.handleChangeStreetFirstParent.bind(values.values)} />
                            </fieldset>
                        </fieldset>
                        <fieldset>
                            <fieldset className="form-group">
                                <input
                                    ...
                                    onChange={values.values.handleChangeCityFirstParent.bind(values.values)} />
                            </fieldset>
                        </fieldset>
                        <fieldset>
                            <fieldset className="form-group">
                                <input
                                    ...
                                    onChange={values.values.handleChangeProvinceFirstParent.bind(values.values)} />
                            </fieldset>
                        </fieldset>
                        <fieldset>
                            <fieldset className="form-group">
                                <input
                                    ...
                                    onChange={values.values.handleChangePostalCodeFirstParent.bind(values.values)} />
                            </fieldset>
                        </fieldset>
                        ...
                        <fieldset className="form-group">
                            <Select
                                ...
                                isMulti={true}
                                isSearchable={true}
                                onChange={values.values.handleChangeAvocatFirstParent.bind(values.values)}>
                                )}
                        </Select>
                        </fieldset>
                    </div>
                    <div class="col-md-6 form-group">
                            ...
                            <div className="row">
                                <div class="col-md-12 form-group">
                                    ...
                                    <Select
                                        ...
                                        onChange={values.values.handleChangeSecondParentType.bind(values.values)}
                                        isMulti={false}
                                        isSearchable={true}
                                        options={values.parentTypeArray}>
                                    </Select>
                        ...
                        <fieldset>
                            ...
                            <Select
                                    ...
                                    onChange={values.values.handleChangeSecondAddressSelected.bind(values.values)} />
                            </fieldset>
                        </fieldset>
                        <fieldset>
                            <fieldset className="form-group">
                                <input
                                    ...
                                    onChange={values.values.handleChangeNoCiviqueSecondParent.bind(values.values)} />
                            </fieldset>
                        </fieldset>
                        <fieldset>
                            <fieldset className="form-group">
                                <input
                                    ...
                                    onChange={values.values.handleChangeStreetSecondParent.bind(values.values)} />
                            </fieldset>
                        </fieldset>
                        <fieldset>
                            <fieldset className="form-group">
                                <input
                                    ...
                                    onChange={values.values.handleChangeCitySecondParent.bind(values.values)} />
                            </fieldset>
                        </fieldset>
                        <fieldset>
                            <fieldset className="form-group">
                                <input
                                    ...
                                    onChange={values.values.handleChangeProvinceSecondParent.bind(values.values)} />
                            </fieldset>
                        </fieldset>
                        <fieldset>
                            <fieldset className="form-group">
                                <input
                                    ...
                                    onChange={values.values.handleChangePostalCodeSecondParent.bind(values.values)} />
                            </fieldset>
                        </fieldset>
                        ...
                        <fieldset className="form-group">
                            <Select
                                ...
                                isMulti={true}
                                isSearchable={true}
                                onChange={values.values.handleChangeAvocatSecondParent.bind(values.values)}>
                                )}
                        </Select>
                        </fieldset>
                    </div>
...
const mapDispatchToProps = dispatch => ({
    ...
    onSubmit: (serviceType, noDossierFamille, date, frequence, assumeFrais, motifs, transport, parent, secondParent, enfants, disposFirstParent, disposSecondParent) => {
        const payload = agent.DemandeService.register(serviceType, noDossierFamille, date, frequence, assumeFrais, motifs, transport, parent, secondParent, enfants, disposFirstParent, disposSecondParent);
...
export class CreateDemandeService extends React.Component {
    constructor() {
        super();
        this.changeNoDossierFamille = ev => this.props.onChangeNoDossierFamille(ev.target.value);
        this.changeFrequence = ev => this.props.onChangeFrequence(ev.target.value);
        this.changeAssumeFrais = ev => this.props.onChangeAssumeFrais(ev.target.value);
        this.changeMotifs = ev => this.props.onChangeMotifs(ev.target.value);
        this.changeTransportName = ev => this.props.onChangeTransportName(ev.target.value);
        this.changeTransportPhone = ev => this.props.onChangeTransportPhone(ev.target.value);
        this.changeParentNom = ev => this.props.onChangeParentNom(ev.target.value);
        this.changeParentPrenom = ev => this.props.onChangeParentPrenom(ev.target.value);
        this.changeParentEmail = ev => this.props.onChangeParentEmail(ev.target.value);
        this.changeParentPhone = ev => this.props.onChangeParentPhone(ev.target.value);
        this.changeParentBirthdate = ev => this.props.onChangeParentBirthdate(ev.target.value);
        this.changeParentNoLicense = ev => this.props.onChangeParentNoLicense(ev.target.value);
        this.changeParentNoRAMQ = ev => this.props.onChangeParentNoRAMQ(ev.target.value);
        this.changeParentNote = ev => this.props.onChangeParentNote(ev.target.value);
        this.changeParentContact = ev => this.props.onChangeParentContact(ev.target.value);
        this.changeSecondParentNom = ev => this.props.onChangeSecondParentNom(ev.target.value);
        this.changeSecondParentPrenom = ev => this.props.onChangeSecondParentPrenom(ev.target.value);
        this.changeSecondParentEmail = ev => this.props.onChangeSecondParentEmail(ev.target.value);
        this.changeSecondParentPhone = ev => this.props.onChangeSecondParentPhone(ev.target.value);
        this.changeSecondParentBirthdate = ev => this.props.onChangeSecondParentBirthdate(ev.target.value);
        this.changeSecondParentNoLicense = ev => this.props.onChangeSecondParentNoLicense(ev.target.value);
        this.changeSecondParentNoRAMQ = ev => this.props.onChangeSecondParentNoRAMQ(ev.target.value);
        this.changeSecondParentNote = ev => this.props.onChangeSecondParentNote(ev.target.value);
        this.changeSecondParentContact = ev => this.props.onChangeSecondParentContact(ev.target.value);
        this.changeEnfantNom = ev => this.props.onChangeEnfantNom(ev.target.value);
        this.changeEnfantPrenom = ev => this.props.onChangeEnfantPrenom(ev.target.value);
        this.changeEnfantNoRAMQ = ev => this.props.onChangeEnfantNoRAMQ(ev.target.value);
        this.changeEnfantAllergies = ev => this.props.onChangeEnfantAllergies(ev.target.value);
        this.changeEnfantBirthdate = ev => this.props.onChangeEnfantBirthdate(ev.target.value);
        ...
        this.changeSearchFirstParentPostalCode = ev => this.setState({ 'searchFirstParentPostalCode': ev.target.value }); 
        this.changeSearchSecondParentPostalCode = ev => this.setState({ 'searchSecondParentPostalCode': ev.target.value }); 
        ...
        this.submitForm = (noDossier, frequence, assumeFrais, transportName, transportPhone, firstParent, secondParent) => ev => {
            ev.preventDefault();
            var transport = {
                name: transportName,
            ...
            this.props.onSubmit(this.state.serviceType, noDossier, this.state.Date, frequence, assumeFrais, this.state.motifsSelected, transport, firstParent, secondParent, this.state.enfants, this.state.disposFirstParent, this.state.disposSecondParent);
        }
    }
    ...
    addEnfant(newEnfant) {
        if (typeof newEnfant.lastname != 'undefined' && newEnfant.lastname != "" && typeof newEnfant.firstname != 'undefined' && newEnfant.firstName != "" && typeof newEnfant.noRAMQ != 'undefined' && newEnfant.noRAMQ != "" && typeof newEnfant.birthdate != 'undefined' && newEnfant.birthdate != "" && typeof newEnfant.allergies != 'undefined' && newEnfant.allergies != "") {
            this.setState({
                enfants: this.state.enfants.concat([{ noRAMQ: newEnfant.noRAMQ, birthdate: newEnfant.birthdate, allergies: newEnfant.allergies, firstname: newEnfant.firstname, lastname: newEnfant.lastname }])
            })
        }
    }
    ...
    addDispoFirstParent(date) {
        if (typeof date != 'undefined' && typeof date.from != 'undefined' && typeof date.to != 'undefined') {
            this.setState({
                disposFirstParent: this.state.disposFirstParent.concat([{ date: date.date.toDate(), from: date.from, to: date.to }])
            })
        }
    }
    ...
    addDispoSecondParent(date) {
        if (typeof date != 'undefined' && typeof date.from != 'undefined' && typeof date.to != 'undefined') {
            this.setState({
                disposSecondParent: this.state.disposSecondParent.concat([{ date: date.date.toDate(), from: date.from, to: date.to }])
            })
        }
    }
    ...
    render() {
        ...
        const ServiceTypeArray = [{ value: '1', label: 'Visite supervisée' }, { value: '2', label: 'Conversation téléphonique supervisée' }, { value: '3', label: 'Échange de garde supervisé' }];
        const parentTypeArray = [{ value: '1', label: 'Parent gardien' }, { value: '2', label: 'Parent visiteur' }, { value: '3', label: 'Tuteur' }, { value: '4', label: 'Famille accueil' }];
        ...
        return (
            <div className="auth-page">
                <div className="container page">
                    <hr />
                    <h1 className="text-xs-center">Créer demande de service</h1>
                    <hr />
                    <br />
                    <br />
                    ...
                    <div className="col-md-12 offset-md-1 col-xs-12">
                        ...
                        <form className="form-group" onSubmit={this.submitForm(noDossierFamille, frequence, assumeFrais, transportName, transportPhone, firstParent, secondParent).bind(this)}>
                            <div class="row">
                                <div class="col-md-12">
                            ...
                            <div class="row">
                                <fieldset className="form-group col-md-3">
                                    <DatePicker className="form-control form-control-lg" placeholderText="Date" selected={this.state.Date} onChange={this.handleChangeDate.bind(this)} />
                                </fieldset>
                                <fieldset className="form-group col-md-3">
                                    <input
                                        className="form-control form-control-lg"
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <h3 className="text-xs-center">Type de service demandé</h3>
                                </div>
                            </div>
                            <div class="row">
                                <Select
                                ...
                                <div class="col-md-12">
                                    <fieldset className="form-group">
                                        <input
                                            className="form-control form-control-lg"
                                            type="text"
                                            placeholder="Ajout un nouveau motif ne figurant pas dans la liste"
                                            value={this.state.newMotif}
                                            onChange={this.handleChangeNewMotif.bind(this)} />
                                        <button type="button" onClick={this.addNewMotif(this.state.newMotif).bind(this)}>Ajouter</button>
                                    </fieldset>
                                </div>
                            </div>
                            <br />
                            <div className="row">
                                <div class="col-md-4 form-group">
                                    ...
                                    <ul className="list-group text-center">
                                        {(enfantsAjouter != null) &&
                                            Object.keys(enfantsAjouter).map(function (key) {
                                                return <li className="list-group-item list-group-item-info">{enfantsAjouter[key].label}</li>
                                            }.bind(this))
                                        }
                                    </ul>
                                    <fieldset className="form-group">
                                    ...
                                    <button type="button" onClick={() => { this.addEnfant({ firstname: newEnfant.firstname, lastname: newEnfant.lastname, birthdate: newEnfant.birthdate, noRAMQ: newEnfant.noRAMQ, allergies: newEnfant.allergies }) }}>Ajouter</button>
                                ...
                                <InfoFormEnfantsParents values={this} props={this.props} serviceType={serviceType} addresses={addresses} firstParentType={firstParentType} secondParentType={secondParentType}
                                    avocats={avocats} parentTypeArray={parentTypeArray} firstParent={firstParent} secondParent={secondParent} />
                                <div className="row">
...
export default connect(mapStateToProps, mapDispatchToProps)(CreateDemandeService);
