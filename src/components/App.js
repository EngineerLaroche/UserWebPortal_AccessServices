      ...
      return (
        ...
        >
          <div>
            <Header
              appName={
                <FormattedMessage id="app.name" defaultMessage="RQRSDA" />
              }
            ...
            <Switch>
              ...
              <Route
                path="/organismereferent/create"
                component={CreateOrganismeReferent}
              />
              <Route
                path="/organismereferent/edit/:email"
                component={EditOrganismeReferent}
              />
              <Route
                path="/organismereferent/:email"
                component={OrganismeReferentDetails}
              />
              <Route
                path="/organismereferents"
                component={ListOrganismeReferents}
              />
              ...
              <Route
                path="/pointService/create"
                component={CreatePointService}
              />
              <Route
                path="/pointService/edit/:email"
                component={EditPointService}
              />
              <Route
                path="/pointService/:email"
                component={PointServiceDetails}
              />
              ...
              <Route
                path="/demandeService/create"
                component={CreateDemandeService}
              />
              <Route
                path="/demandeService/edit/:id"
                component={EditDemandeService}
              />
              <Route
                path="/demandeService/:id"
                component={DetailsDemandeService}
              />
